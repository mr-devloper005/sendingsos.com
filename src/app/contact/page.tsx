        ...
        <section className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
          ...
          <div className={`rounded-[2rem] p-7 ${tone.panel}`}>
            ...
            <form className="mt-6 grid gap-4">
              <input className="h-12 rounded-xl border border-[#d8c7bc] bg-[#fff8f2] px-4 text-sm text-[#452829] placeholder:text-[#a0918b]" placeholder="Your name" />
              <input className="h-12 rounded-xl border border-[#d8c7bc] bg-[#fff8f2] px-4 text-sm text-[#452829] placeholder:text-[#a0918b]" placeholder="Email address" />
              <input className="h-12 rounded-xl border border-[#d8c7bc] bg-[#fff8f2] px-4 text-sm text-[#452829] placeholder:text-[#a0918b]" placeholder="What do you need help with?" />
              <textarea className="min-h-[180px] rounded-2xl border border-[#d8c7bc] bg-[#fff8f2] px-4 py-3 text-sm text-[#452829] placeholder:text-[#a0918b]" placeholder="Share the full context so we can respond with the right next step." />
